...
func (lm loggingMiddleware) Create(ctx context.Context, src string) (id Code, err error) {
	defer func() {
...
func (lm loggingMiddleware) Read(ctx context.Context, id Code) (src string, err error) {
	defer func() {
...
func (lm loggingMiddleware) Delete(ctx context.Context, id Code) (err error) {
	defer func() {
...
func (lm loggingMiddleware) SearchMatches(ctx context.Context, input string, limit uint32, cursor Code) (page []Code, err error) {
	defer func() {
